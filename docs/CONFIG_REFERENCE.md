...
| Key | Default | Env var(s) |
|-----|---------|------------|
| enable_skills_knowledge | **true** | ARGUS_ENABLE_SKILLS_KNOWLEDGE |
| skills_repo_path | "" (auto-discovered) | ARGUS_SKILLS_REPO_PATH |

Injects cybersecurity runbook context from the [Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills) repo into Phase 3 agent prompts. **On by default** — auto-discovers the repo in sibling directories, `~/Repos/`, or home directory. Set `skills_repo_path` explicitly to override auto-discovery.
