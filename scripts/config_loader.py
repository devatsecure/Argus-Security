...
def get_default_config() -> dict[str, Any]:
    ...
    return {
        ...
        "enable_skills_knowledge": True,  # inject cybersecurity skills context into agent prompts (auto-discovers repo)
        "skills_repo_path": "",  # path to skills repo (auto-discovered if empty)
    }
